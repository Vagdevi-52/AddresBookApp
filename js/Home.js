    ...
    for (let index = 0; index < addressBookList.length; index++) {
        innerHtml = `${innerHtml}
            <tr>
                ...
                <td>
                <img id="1" onclick="remove(this)" src="file:///C:/Users/MY%20PC/OneDrive/Desktop/AddressBookApp/Assets/Icons/delete.png" alt="delete">
                    <img id="1" onclick="update(this)" src="file:///C:/Users/MY%20PC/OneDrive/Desktop/AddressBookApp/Assets/Icons/create.png" alt="edit">
                </td>
            </tr>
        `;
    }
